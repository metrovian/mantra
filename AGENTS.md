...
- keep executable command files in this order: shebang, `set -euo pipefail`, `ROOT_DIR`, one blank line, then sourcing
...
- wrap long commands with continuation indentation instead of adding temporary variables only for formatting
